...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wash Dashboard — Live Wash Site Monitoring" },
      { name: "description", content: "Live dashboard for wash counts, fresh water, and chemical levels across your sites." },
      { property: "og:title", content: "Wash Dashboard — Live Wash Site Monitoring" },
      ...
      { name: "twitter:title", content: "Wash Dashboard — Live Wash Site Monitoring" },
