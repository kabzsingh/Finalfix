          ...
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9f9f9; padding: 20px; border-radius: 0 0 8px 8px; border: 1px solid #eee; border-top: none;">
              ...
              <p style="margin: 20px 0 0 0; padding-top: 20px; border-top: 1px solid #ddd; color: #999; font-size: 12px;">
                This is a test email from Autowash Dashboard. <a href="https://auto.washdashboard.workers.dev/" style="color: #667eea; text-decoration: none;">View dashboard</a>
              </p>
            </div>
          </div>
        `;
        ...
        const results = await Promise.all(
          recipients.map((email: string) =>
            fetch("https://api.resend.com/emails", {
              ...
              body: JSON.stringify({
                from: "Autowash Dashboard <onboarding@resend.dev>",
                to: email,
                subject: `[TEST] Autowash Dashboard Report: ${siteName}`,
                html: htmlContent,
              }),
            })
              .then((r) => r.json())
          ...
          const htmlContent = `
            <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
              ...
              <div style="background: #f9f9f9; padding: 20px; border-radius: 0 0 8px 8px; border: 1px solid #eee; border-top: none;">
                ...
                <p style="margin: 20px 0 0 0; padding-top: 20px; border-top: 1px solid #ddd; color: #999; font-size: 12px;">
                  This is an automated ${reportType.toLowerCase()} report from Autowash Dashboard. <a href="https://auto.washdashboard.workers.dev/" style="color: #667eea; text-decoration: none;">View dashboard</a>
                </p>
              </div>
            </div>
          `;
          ...
          for (const email of recipients) {
            const resendResponse = await fetch("https://api.resend.com/emails", {
              ...
              body: JSON.stringify({
                from: "Autowash Dashboard <onboarding@resend.dev>",
                to: email,
                subject: `Autowash Dashboard ${reportType} Report: ${siteName}`,
                html: htmlContent,
              }),
            });
